 ...
 **Avatar Styling**
 ...
 In addition to the style attribute, ngx-avatar style can be customized usinhg css classes. Thus, the generated code offers two css classes that can be overridden :
